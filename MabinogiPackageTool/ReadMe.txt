...
应用程序向导已为您创建了此 MabinogiPackageTool 应用程序。此应用程序不仅演示 Microsoft 基础类的基本使用方法，还可作为您编写应用程序的起点。
...
MabinogiPackageTool.h
    这是应用程序的主头文件。
    其中包括其他项目特定的标头（包括 Resource.h），并声明 CMabinogiPackageToolApp 应用程序类。

MabinogiPackageTool.cpp
    这是包含应用程序类 CMabinogiPackageToolApp 的主应用程序源文件。
...
res\MabinogiPackageTool.ico
    这是用作应用程序图标的图标文件。此图标包括在主资源文件 MabinogiPackageTool.rc 中。
...
MabinogiPackageToolDoc.h、MabinogiPackageToolDoc.cpp - 文档
    这些文件包含 CMabinogiPackageToolDoc 类。编辑这些文件以添加特殊文档数据并实现文件保存和加载（通过 CMabinogiPackageToolDoc::Serialize）。
    该文档将包含以下字符串：
        文件扩展名：      pack
...
MabinogiPackageToolView.h、MabinogiPackageToolView.cpp - 文档视图
